...
def move_left(robot, arm='left', distance_cm=3.0, frame='world', camera_pose=None):
    """
    Move the robot's end-effector to the left by a specified distance using curobo IK.
