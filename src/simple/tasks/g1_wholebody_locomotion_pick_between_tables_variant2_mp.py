...
_PLACE_HEIGHT = 0.3
@TaskRegistry.register("g1_wholebody_locomotion_pick_between_tables_variant2_mp")
class G1WholebodyLocomotionPickBetweenTablesTaskVariant2MP(Task):
    uid:str = "g1_wholebody_locomotion_pick_between_tables_variant2_mp"
    label: str = "G1 Wholebody Locomotion Pick and Place variant 2 MP"
    ...
    dr_cfgs: dict[str, RandomizerCfg] = dict(
        ...
        spatial = SpatialDRCfg(
            ...
            target_rotate_z = Box(low=3.12, high=3.16),
            obj_surface_map={
                "target": "table",
                "container": "table2",
    ...
    def decompose(self):
        ...
        place_origon = Box(low=[-0.1, -0.15], high=[0.1, 0.05])
        ...
        return [
            ...
            WalkSpec("walk_to_table2", vx=0.35, vy=0.15, target_yaw=0, target_distance=0.3),
