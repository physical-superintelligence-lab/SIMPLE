...
_PLACE_HEIGHT = 0.45
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_turn_x_move_and_pick_variant1_mp")
class G1WholebodyTurnXMoveAndPickVariant1MP(Task):
    uid:str = "g1_wholebody_turn_x_move_and_pick_variant1_mp"
    label: str = "G1 Wholebody Turn X Move and Pick Variant 1 MP"
