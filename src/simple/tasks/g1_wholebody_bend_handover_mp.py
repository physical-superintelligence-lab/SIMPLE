...
_PLACE_HEIGHT = 0.45
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_bend_handover_mp")
class G1WholebodyBendHandoverMP(Task):
    uid:str = "g1_wholebody_bend_handover_mp"
    label: str = "G1 Wholebody Bend Handover MP"
    description: str = "A task where the G1 Wholebody robot must bend and pick up an object using right hand and hand it to the left hand."
    ...
    def decompose(self):
        ...
        transition_region = Box(low=[-0.32, 0.2], high=[-0.4, 0.3])
        ...
        return [
            ...
            StandSpec("stand",steps=30,keep_waist_pose=True),
