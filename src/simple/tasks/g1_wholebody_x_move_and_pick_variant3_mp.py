...
_PLACE_HEIGHT = 0.1
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_x_move_and_pick_variant3_mp")
class G1WholebodyXMoveAndPickVariant3MP(Task):
    uid:str = "g1_wholebody_x_move_and_pick_variant3_mp"
    label: str = "G1 Wholebody X Move and Pick Variant 3 MP"
    ...
    dr_cfgs: dict[str, RandomizerCfg] = dict(
        ...
        spatial = SpatialDRCfg(
            ...
            target_region=Box(low=[-0.32, 0.36], high=[-0.35, 0.41]),
    ...
    def __init__(
        ...
        scene_uid: str | Scene = "hssd:scene20",
    ...
    def decompose(self):
        ...
        return [
            ...
            WalkSpec("walk to target",vx=0.35, target_yaw=0, target_distance=0.4),
