...
_PLACE_HEIGHT = 0.4
@TaskRegistry.register("g1_wholebody_locomotion_pick_between_tables_variant5_mp")
class G1WholebodyLocomotionPickBetweenTablesTaskVariant5MP(Task):
    uid:str = "g1_wholebody_locomotion_pick_between_tables_variant5_mp"
    label: str = "G1 Wholebody Locomotion Pick and Place variant 5 MP"
