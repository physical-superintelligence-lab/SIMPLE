...
_PLACE_HEIGHT = 0.45
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_bend_pick_and_place_mp")
class G1WholebodyBendPickAndPlaceMP(Task):
    uid:str = "g1_wholebody_bend_pick_and_place_mp"
    label: str = "G1 Wholebody Bend Pick and Place MP"
    description: str = "A task where the G1 Wholebody robot must bend and pick up an object and place it on a table."
    ...
    dr_cfgs: dict[str, RandomizerCfg] = dict(
        ...
        spatial = SpatialDRCfg(
            ...
            container_region=Box(low=[-0.16, -0.09], high=[-0.12, 0.02]),
