...
_LIFT_HEIGHT = 0.02
@TaskRegistry.register("g1_wholebody_tabletop_grasp_variant2_mp")
class G1WholebodyTabletopGraspVariant2MP(Task):
    uid:str = "g1_wholebody_tabletop_grasp_variant2_mp"
    label: str = "G1 Wholebody Tabletop Grasp Variant 2 MP"
    ...
    dr_cfgs: dict[str, RandomizerCfg] = dict(
        ...
        spatial = SpatialDRCfg(
            spatial_mode="random",
            robot_region=Box(low=[-0, 1.2,0.0], high=[-0,1.25,0.0]),
            robot_orientation_region=Box(low=[0.717, 0, 0, -0.717], high=[0.717, 0, 0, -0.717]),

            target_region=Box(low=[-0.03, 0.83], high=[0.02, 0.9]),
