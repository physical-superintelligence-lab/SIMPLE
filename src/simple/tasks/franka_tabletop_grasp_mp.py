...
@TaskRegistry.register("franka_tabletop_grasp_mp")
class FrankaTabletopGraspTaskMP(Task):
    
    uid: str = "franka_tabletop_grasp_mp"
    label: str = "Franka Tabletop Grasp Task"
    description: str = "A task that the Franka robot must grasp target object on a tabletop."
    ...
    def clone_layout(self, options: dict[str, Any]) -> None: # TODO delete 
