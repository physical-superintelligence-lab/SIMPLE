...
_PLACE_HEIGHT = 0.45
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_x_move_and_handover_mp")
class G1WholebodyXMoveAndHandoverMP(Task):
    uid:str = "g1_wholebody_x_move_and_handover_mp"
    label: str = "G1 Wholebody X Move and Handover MP"
