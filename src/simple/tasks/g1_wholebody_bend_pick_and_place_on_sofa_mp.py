...
_LIFT_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_bend_pick_and_place_on_sofa_mp")
class G1WholebodyBendPickAndPlaceOnSofaMP(Task):
    uid:str = "g1_wholebody_bend_pick_and_place_on_sofa_mp"
    label: str = "G1 Wholebody Bend Pick And Place On Sofa MP"
