...
_PLACE_HEIGHT = 0.1
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_x_move_and_handover_variant1_mp")
class G1WholebodyXMoveAndHandoverVariant1MP(Task):
    uid:str = "g1_wholebody_x_move_and_handover_variant1_mp"
    label: str = "G1 Wholebody X Move and Handover Variant 1 MP"
    ...
    def __init__(
        ...
        scene_uid: str | Scene = "hssd:scene34",
       ...
       # lazy init instance variables
        ...
        #HACK This task only in scene20
    ...
    def decompose(self):
        ...
        transition_region = Box(low=[-0.42, 0.45], high=[-0.4, 0.5])
