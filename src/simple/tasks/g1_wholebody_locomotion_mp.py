...
_LIFT_HEIGHT = 0.02
@TaskRegistry.register("g1_wholebody_locomotion_mp")
class G1WholebodyLocomotionTaskMP(Task):
    uid:str = "g1_wholebody_locomotion_mp"
    label: str = "G1 Wholebody Locomotion MP"
    description: str = "A task where the G1 robot must locomote in a wholebody manner."
