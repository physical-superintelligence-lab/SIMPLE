...
_PLACE_HEIGHT = 0.2
_LOWER_HEIGHT = 0.05
@TaskRegistry.register("g1_wholebody_x_move_and_pick_mp")
class G1WholebodyXMoveAndPickMP(Task):
    uid:str = "g1_wholebody_x_move_and_pick_mp"
    label: str = "G1 Wholebody X Move and Pick MP"
    ...
    dr_cfgs: dict[str, RandomizerCfg] = dict(
        ...
        distractors = DistractorDRCfg(
            ...
            exclude=["12","46"]  # Exclude the target object 
        ),
